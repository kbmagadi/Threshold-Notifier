...
def run_test(event: ThresholdEvent):
    print("\n" + "=" * 80)
    print(f"RUNNING TEST: {event.rule_name}")
    print("=" * 80)
    handle_threshold_event(event)


# 1️⃣ Revenue Drop — Conversion + Traffic aligned
run_test(
    ThresholdEvent(
...
# # 2️⃣ Conversion Rate Drop — Traffic up, Revenue down
# run_test(
#     ThresholdEvent(
...
# # 3️⃣ Traffic Spike Without Revenue
# run_test(
#     ThresholdEvent(
